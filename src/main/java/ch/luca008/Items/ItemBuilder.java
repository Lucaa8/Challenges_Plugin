...
public class ItemBuilder {
    ...
    public ItemBuilder setPrivateName(String privateName) {
    ...
    public Item createItem() {
        Item i = new Item(privateName, uid, material, name, lore, enchantList, flags, attributes, meta, repairCost, customData, damage, invulnerable);
        if(glowing){
            i.glow();
        }
        return i;
