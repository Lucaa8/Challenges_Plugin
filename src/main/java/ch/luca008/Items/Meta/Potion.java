...
public class Potion implements Meta{
    ...
    public Potion(JSONObject json){
        if(json.containsKey("Color")){
            ...
            if(o instanceof JSONObject){
                ...
                color = Color.fromRGB(JsonUtils.getInt(j, "r"),JsonUtils.getInt(j, "g"),JsonUtils.getInt(j, "b"));
            }
        }
        ...
        if(json.containsKey("CustomEffects")){
            ...
            for (Object o : jarr) {
                JSONObject j = (JSONObject) o;
                customsEffects.add(new PotionEffect(PotionEffectType.getByName((String)j.get("Type")), JsonUtils.getInt(j,"Duration"), JsonUtils.getInt(j,"Amplifier"), j.containsKey("Ambient")?(boolean) j.get("Ambient"):false, j.containsKey("Particles")?(boolean)j.get("Particles"):false));
            }
        }
    }
    ...
    @Override
    public boolean hasSameMeta(ItemStack item, @Nullable UniPlayer player) {
